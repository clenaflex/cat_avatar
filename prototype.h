...
extern void get_eye_color(cv::Mat eye_img,cv::Point ellipse_pq,int a ,int b,int theta,cv::Scalar eye_color[2]);
...
extern int shima_detect(cv::Mat img);
extern void wider_rect(cv::Mat src_img,double param, int result[4]);
extern void detect_cat_face(cv::Mat src_img,int result[4]);
extern void detect_cat_ears(cv::Mat cat_face,int result[2][4]);
extern void detect_cat_eyes(cv::Mat cat_face,int result[2][4]);
extern void detect_cat_mouth(cv::Mat cat_face,int result[4]);
